				...
				<div class="inner clearfix">
					...
					<div class="list-data">
						<table>
							...
							<tr>
								<th><label><?php _e("Video URL",'acf'); ?>:</label></th>
								<td class="td-video"><?php echo $attachment['video_url']; ?></td>
							</tr>
							</tbody>
						</table>
					</div>
		...
		<div class="inner clearfix">
			...
			<div class="list-data">
				...
				<tbody>
					...
					<tr>
						<th><label><?php _e("Video URL",'acf'); ?>:</label></th>
						<td class="td-video">{video_url}</td>
					</tr>
				</tbody>
			</table>
			</div>
	...
	function format_value( $value, $post_id, $field )
	{
		...
		foreach( $attachments as $attachment)
		{
			...
			$ordered_attachments[ $attachment->ID ] = array(
				...
				'video_url' 	=>  get_post_meta($attachment->ID, '_attachment_video_url', true),
			);
